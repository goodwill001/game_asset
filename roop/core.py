...
processors = {'faceswap': {}, 'restoreformer++': {}}
...
def batch_process_regular(files:list[ProcessEntry], masking_engine:str, use_new_method, imagemask, num_swap_steps, progress, selected_index = 0) -> None:
    global process_mgr
    ...
    options = ProcessOptions(get_processing_plugins(masking_engine), roop.globals.distance_threshold, roop.globals.blend_ratio,
                              roop.globals.face_swap_mode, selected_index, mask, num_swap_steps,
